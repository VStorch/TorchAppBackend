...
public class PetShopInformationResponseDTO {
    private Long id;
    private String name;
    ...
    // Construtores
    public PetShopInformationResponseDTO() {
    }

    public PetShopInformationResponseDTO(Long id, String name, String description, String logoUrl,
                                         List<String> services, String instagram, String facebook,
                                         String website, String whatsapp, String commercialPhone,
